...
namespace MATP{
    ...
    struct Line {
        ...
        [[nodiscard]] point3d direction() const {
        ...
        [[nodiscard]] bool includePoint(const point3d &point) const {
            return abs(point.distance(start_point) + point.distance(end_point) - length()) < SP_EPSILON_FLOAT;
        }
