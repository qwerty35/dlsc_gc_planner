#ifndef DLSC_GC_PLANNER_UTIL_HPP
#define DLSC_GC_PLANNER_UTIL_HPP
...
namespace MATP {
    ...
    static std_msgs::ColorRGBA defaultColor(){
    ...
    static std::vector<std::array<double, 3>> point3DsToArray(const point3ds& points){
        /* Allocate memory. */
...
#endif //DLSC_GC_PLANNER_UTIL_HPP
