#ifndef DLSC_GC_PLANNER_BERNSTEIN_TRAJECTORY_HPP
#define DLSC_GC_PLANNER_BERNSTEIN_TRAJECTORY_HPP
...
namespace MATP{
    ...
    static point3d getPointFromControlPoints(point3ds control_points,
                                             double t_normalized){
        point3d point;
    ...
    static point3ds bernsteinFitting(point3ds target_points, std::vector<double> ts_normalized){
...
//                    std::cout << "coef2: " << std::endl << coef2 << std::endl;
    ...
    static double distanceBetweenPolys(const point3ds& control_points_agent,
                                       const point3ds& control_points_obs,
...
#endif //DLSC_GC_PLANNER_BERNSTEIN_TRAJECTORY_HPP
