#ifndef DLSC_GC_PLANNER_TRAJ_OPTIMIZER_HPP
#define DLSC_GC_PLANNER_TRAJ_OPTIMIZER_HPP
...
namespace MATP {
    ...
    public:
        ...
        TrajOptResult solve(const Agent& agent,
...
#endif //DLSC_GC_PLANNER_TRAJ_OPTIMIZER_HPP
