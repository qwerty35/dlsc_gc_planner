...
namespace MATP {
    bool Param::initialize(const ros::NodeHandle &nh) {
        ...
        nh.param<bool>("multisim/show_feasible_region", multisim_show_feasible_region, false);
        ...
        nh.param<double>("obs/duration", obs_duration, -1);
        nh.param<double>("obs/velocity_threshold", obs_velocity_threshold, 0.1);
        ...
        nh.param<int>("grid/safe_distance", grid_safe_distance, 4);
        ...
        package_path = ros::package::getPath("dlsc_gc_planner");
